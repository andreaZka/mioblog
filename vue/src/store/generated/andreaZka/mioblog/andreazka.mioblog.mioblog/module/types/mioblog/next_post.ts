...
const baseNextPost: object = { idValue: 0 };

export const NextPost = {
  encode(message: NextPost, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): NextPost {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseNextPost } as NextPost;
  ...
  toJSON(message: NextPost): unknown {
    const obj: any = {};
    message.idValue !== undefined && (obj.idValue = message.idValue);
    return obj;
  },

  fromPartial(object: DeepPartial<NextPost>): NextPost {
    const message = { ...baseNextPost } as NextPost;
    if (object.idValue !== undefined && object.idValue !== null) {
